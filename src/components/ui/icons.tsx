...
export function LaptopIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="14" height="10" x="5" y="4" rx="1.5" />
      <path d="M3 18h18" />
      <path d="M7 18l1.5-2h7L17 18" />
    </svg>
  );
}
...
export function ScreenIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PlugIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
