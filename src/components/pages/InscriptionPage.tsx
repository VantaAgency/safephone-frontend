...
function InscriptionContent() {
  ...
  // Filter plans by active market — same rule as PlansPreview/PlansPage.
  const plans = useMemo(() => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="shrink-0 text-right">
                            {(() => {
                              const planMarket = plan.slug.startsWith("us_") ? MARKETS.US : MARKETS.SN;
                              const { value, period } = splitPrice(
                              ...
                              return (
                                <>
                                  <div className="text-lg font-medium text-indigo-950">{value}</div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between border-t border-yellow-300/30 pt-3">
                      ...
                      <span className="text-xl font-medium text-indigo-950">
                        {(() => {
                          const planMarket = selectedPlanObj.slug.startsWith("us_") ? MARKETS.US : MARKETS.SN;
                          const { value, period } = splitPrice(
                            annual ? selectedPlanObj.price_annual : selectedPlanObj.price_monthly,
                            planMarket,
                            annual ? "annual" : "monthly",
                            lang,
                          );
                          return (
                            <>
                              {value}
                              <span className="ml-1 text-xs font-normal text-slate-400">{period}</span>
                            </>
                          );
                        })()}
                      </span>
