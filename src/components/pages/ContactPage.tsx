...
/**
 * Shared contact page body. Hardcoded WhatsApp + address + email are
 * refactored to read from market.contact in Phase 3.
 */
            ...
            {market.contact.whatsapp && (
              ...
              >
                ...
                <div>
                  ...
                  {market.contact.whatsappDisplay && (
                    <div className="mt-1 text-sm font-semibold text-[#25D366]">{market.contact.whatsappDisplay}</div>
                  )}
                </div>
              </a>
            )}

            {market.contact.address && (
              <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-sm text-indigo-950 whitespace-pre-line">{market.contact.address}</div>
                  </div>
                </div>
              </div>
            )}
