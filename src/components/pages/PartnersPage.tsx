...
// Cities come from MARKETS[market.code].partnerCities so SN ships Senegalese
// cities and US ships US metros.
      ...
      <div className="space-y-4">
        ...
        <FormField label={t.partners.name} error={fieldErrors.storeName}>
          <Input
            ...
            placeholder={market.code === "US" ? "Smith Mobile Repair" : "Boutique Diallo Mobile"}
